			   	...
			   	<tr>
					<td>
					  ...
					  <?php
						...
						echo '<td class="headline"><div align="center"><a href="billing_tz_archive_date.php?print=true&page=1&sortby=selian_pid&sorttyp='.$sorttyp.'&day='.$day.'&month='.$month.'&year='.$year.'&selected_date='.$selected_date.'&txtsearch='.$_REQUEST['txtsearch'].'&searchtyp='.$_REQUEST['searchtyp'].'">Name</a>'.$img_pid.'</div></td>';
					 	...
					 	echo '<td class="headline"><div align="center"><a href="billing_tz_archive_date.php?print=true&page=1&sortby=user_id&sorttyp='.$sorttyp.'&day='.$day.'&month='.$month.'&year='.$year.'&selected_date='.$selected_date.'&txtsearch='.$_REQUEST['txtsearch'].'&searchtyp='.$_REQUEST['searchtyp'].'">CashierName</a>'.$img_user.'</div></td>';
							...
							$total_sum = $bill_obj->DisplayAllArchivedBill($txtsearch,$searchtyp,$start_timeframe,$end_timeframe, $trans_id, 4000,$day,$month, $year, $sorttyp, $view);	
