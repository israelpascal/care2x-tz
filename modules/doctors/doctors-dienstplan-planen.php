...
if ($relems['s'.$n]=="") $smarty->assign('sIcon3','<img '.createComIcon($root_path,'warn.gif','0').'>');
		else $smarty->assign('sIcon3','<img '.createComIcon($root_path,'mans-red.gif','0').'>');
