...
<?php $bill_obj->Display_Headline($LDBilling,'','','billing_overview.php','Billing :: Main Menu'); ?>
				...
				<TD valign="middle">
                    ...
                    <TBODY class="submenu" valign="middle">
                      <TR valign="middle">
                        ...
                        <TD class="submenu_item"><nobr><a href="billing_tz_pass.php?target=quotes&patient=outpatient"><?php echo "Create Outpatient Quotation"?></a></nobr></TD>
                        <TD><?php echo $LDShowPendingQuot; ?></TD>
                      </tr>
                      <TR>
                        <td align=center><img src="../../gui/img/common/default/showdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="billing_tz_pass.php?target=quotes&patient=inpatient"><?php echo "Create Inpatient Quotation"?></a></nobr></TD>
                        <TD><?php echo $LDShowPendingQuot; ?></TD>
                      </tr>
		     
   			<TR>
                        <td align=center><img src="../../gui/img/common/default/showdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="billing_tz_pass.php?target=quotes&patient=artndental"><?php echo "Create ART and Dental Quotation"?></a></nobr></TD>
                        <TD><?php echo $LDShowPendingQuot; ?></TD>
                      </tr>
			...
			<!--<TR>
                      ...
                      <TR>
                        ...
                        <TD class="submenu_item"><nobr><a href="billing_tz_pass.php?target=pending"><?php echo $LDPendingBills?></a></nobr></TD>
                      ...
                      <TR>
                        ...
                        <TD class="submenu_item"><nobr><a href="billing_tz_pass.php?target=reports"><?php echo $LDBillingReports ?></a></nobr></TD>
                        <TD><?php echo $LDBillingReportsTxt; ?></TD>
                      </tr>
...
<!--                     <TD class="submenu_item"><nobr><a href="javascript:open_drug_services()" ><?php echo $LDDrugandService ?></a></nobr></TD>
                      ...
                      <TR>
                        ...
                        <TD class="submenu_item"><nobr><a href="billing_tz_pass.php?target=ins"><?php echo $LDInsuranceManagement ?></a></nobr></TD>
