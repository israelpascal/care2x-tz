...
?> 
                                                        ...
                                                        <TD valign="top" width=130><font  size=1  color="<?php if ($datafound) echo "#0000cc";
                                                            else echo "#3f3f3f"; ?>">
...
?>
                                                        ...
                                                        <TD valign=top width=150>
                                                            <font  size=1  color="<?php if ($datafound) echo "#0000cc";
                                                                        else echo "#3f3f3f"; ?>">
                                                                            <?php if ($datafound) : ?>
                                                                                <?php echo $LDAna ?><br>
...
<?php endif; ?>
                                                                    ...
                                                                    <td><font  size=1 color="<?php if ($datafound) echo "#0000cc";
else echo "#3f3f3f"; ?>">
<?php echo $LDOpInFull ?>:
<?php if ($datafound) : ?>
...
<?php endif; ?>
                                                        ...
                                                        <TD valign="top" width=160><font  size=1 
                                                                                          color="<?php if ($datafound) echo "#0000cc";
else echo "#3f3f3f"; ?>">
<?php
if ($datafound) {
...
?>
                                                        ...
                                                        <TD valign="top" width=140><font  size=1 color="<?php if ($datafound) echo "#0000cc";
else echo "#3f3f3f"; ?>"><?php echo $LDOpMainElements[result] ?><br>
<?php if ($datafound)
    echo '
