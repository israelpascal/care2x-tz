...
if(!$_SESSION['sess_dept_name']) $_SESSION['sess_dept_name'];
...
if($mode=='save')
{
	...
	if(!$scrub_nurse) {$err_scrub_nurse=1;$err_data=1;}
        if(!$assistant) {$err_assistant=1;$err_data=1;}
...
echo '<font color="red">';if($err_assistant) echo '<font color="*">'; ?>  <?php echo $LDassitant.':';
