    	...
    	<table border="0" width="100%" cellpadding="0" cellspacing="0">
    		<tr>
    			<?php
    				...
    				$categories1 = array('druglist', 'Supplies', 'supplies-lab',
'service','CTC-Drugs','Drug-list-NHIF','Drug list for All','xray', 'dental', 'eye-service', 'minor_proc_op', 'obgyne_op', 'ortho_op','surgical_op');//activated tab

    				$categories2 = array('Drug List', 'Supplies', 'Supplies-Lab','service','Drug-List-CTC','Drug-List-NHIF','Drug-List-All','xray','dental', 'Eye-service', 'Minor_op', 'Obgyne_op', 'Ortho_op','Surgical_op');//group

    				$categories3 = array('prescription_drugs.gif', 'prescription_supplies.gif', 'prescription_specialsupplies.gif','prescription_service.gif','prescription_specialdrugs.gif','prescription_specialdrugs.gif','prescription_specialdrugs.gif', 'prescription_xray.gif','prescription_dental.gif', 'eye.gif','prescription_proc.gif', 'prescription_obgyne.gif', 'prescription_bigop.gif','prescription_smallop.gif');//image

    				$categories4 = array('General', 'Supplies', 'Special Supplies','Service/Registration','CTC Drugs','NHIF Drugs','Drugs for All Patients','XRays', 'Dental Services', 'Eye Services', 'Minor Procedures/Dressings', 'OBGyne Procedures', 'Orthopedic Procedures','Surgical Procedures'); //this is hint
