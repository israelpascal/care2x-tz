				...
				<TD valign="middle">
                    ...
                    <TBODY class="submenu" valign="middle">
                      <TR valign="middle">
                        ...
                        <TD class="submenu_item"><nobr><a href="billing_tz_quotation.php?patient=outpatient&sid=<?php echo "$sid&lang=$lang" ?>"><?php echo "Create Outpatient Quotation"?></a></nobr></TD>
                        <TD><?php echo $LDShowPendingQuot; ?></TD>
                      </tr>
                      <TR>
                        <td align=center><img src="../../gui/img/common/default/showdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="billing_tz_quotation.php?patient=inpatient&sid=<?php echo "$sid&lang=$lang" ?>"><?php echo "Create Inpatient Quotation"?></a></nobr></TD>
                        <TD><?php echo $LDShowPendingQuot; ?></TD>
                      </tr>
		     
   			<TR>
                        <td align=center><img src="../../gui/img/common/default/showdata.gif" border=0></td>
                        <TD class="submenu_item"><nobr><a href="billing_tz_quotation.php?patient=artndental&sid=<?php echo "$sid&lang=$lang" ?>"><?php echo "Create ART and Dental Quotation"?></a></nobr></TD>
                        <TD><?php echo $LDShowPendingQuot; ?></TD>
                      </tr>
