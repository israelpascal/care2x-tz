...
<!--                    <tr>
                    ...
                    <tr>
                        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php echo $WebERPLink; ?></b> </FONT></td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_rest_stock_weberp.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo $WebERPLinkStock; ?>
                            </a></FONT><br>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_rest_income_weberp.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo $WebERPLinkInc; ?>
                            </a></FONT><br>
                        </td>
                    </tr>
                    <tr>
