...
if(!$_SESSIONed['sess_user_origin']) $_SESSION['sess_user_origin'];
if(!$_SESSIONed['sess_dept_nr']) $_SESSION['sess_dept_nr'];
...
if(!$_SESSION['sess_date_process']) $_SESSION['sess_date_process'];
