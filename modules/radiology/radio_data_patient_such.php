...
<BODY onLoad="document.sform.keyword.select()">
    ...
    <img <?php echo createComIcon($root_path, 'sthorax.png', '0', 'absmiddle') ?>><FONT  COLOR="<?php echo $cfg[top_txtcolor] ?>" SIZE=5> <b><?php echo "$LDRadData - ";
    $mode = $_REQUEST['mode'];
    if ($mode == 'done') echo "$LDNewData";
    else echo "$LDEditRadData"; ?></b></font>
